(defpackage :grupo01pareja063Oe2504 ; se declara un paquete lisp que usa common-lisp
  (:use :common-lisp :mancala)      ; y mancala, y exporta la función de evaluación
  (:export :heuristica :*alias*))   ; heurística y un alias para el torneo
(in-package grupo01pareja063Oe2504)
...
(defvar *alias* '|PaFueraLoMaloNoNoNo|); alias que aparecerá en el ranking