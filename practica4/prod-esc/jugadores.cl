...
(defvar *ponderaciones* '(0.8340998553664197 0.8638282430956905 0.09359670182422275))
...
(defun heuristica (estado ponderaciones)
  (let* ((tablero (estado-tablero estado)) 
     ...
     (+ (* misFichas (first ponderaciones)) (* misVacias (second ponderaciones)) (* miKalaha (third ponderaciones)))))
